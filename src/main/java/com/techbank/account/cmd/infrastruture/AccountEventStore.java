...
public class AccountEventStore implements EventStore {
    ...
    @Override
    public void saveEvents(String aggrgateId, Iterable<BaseEvents> events, int expectedVersion) {
        var eventStream = eventStoreRepository.findByAggregateIdentifier(aggrgateId);
        ...
        for (var event: events){
            ...
            var eventModel =EventModel.builder()
                    .timeStamp(new Date())
                    .aggregateIdentifier(aggrgateId)
                    .version(version)
    ...
    @Override
    public List<BaseEvents> getEvents(String aggrgateId) {
        var eventStream = eventStoreRepository.findByAggregateIdentifier(aggrgateId);
